package com.cqrs.write.http.error
...
import com.cqrs.common.error.{ConflictException, NotFoundException}
...
object ExceptionHandlerDirective extends Directives with SprayJsonSupport with LazyLogging {
  ...
  val exceptionHandler: ExceptionHandler = ExceptionHandler {
    case th: ConflictException => complete(StatusCodes.Conflict, th, th.msg)
    case th: NotFoundException => complete(StatusCodes.NotFound, th, th.msg)
